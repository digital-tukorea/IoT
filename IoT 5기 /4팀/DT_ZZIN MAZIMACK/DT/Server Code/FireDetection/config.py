...
RTSP_URL = os.getenv("RTSP_URL", "rtsp://admin:Admin123!@192.168.0.13:554/1")
...
ALLOWED_ORIGINS = os.getenv(
    "ALLOWED_ORIGINS",
    "http://34.64.233.6:8080,http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173",
).split(",")
...
MQTT_HOST = os.getenv("MQTT_HOST", "34.64.233.6")       # DB 서버(Mosquitto)의 외부 IP
