...
RTSP_URL = os.getenv("RTSP_URL", "rtsp://admin:Admin123!@192.168.0.13:554/0")
...
# ---------------------------------------------------------------- 서버
# 0.0.0.0이면 같은 공유기 안의 다른 PC에서도 접속할 수 있습니다.
# 이 PC에서만 쓰려면 "127.0.0.1"로 바꾸세요.
SERVER_HOST = os.getenv("SERVER_HOST", "0.0.0.0")
# 로컬 테스트용 CCTV 스트리밍 서버 포트.
