...
DIAGNOSTIC_FIELDS = (
    ...
    # Realtime provider 본문과 사용자 발화는 남기지 않고, 스키마가
    # 보장하는 짧은 식별자만 운영 진단에 사용한다.
    "exception_type",
    "provider_error_type", "provider_error_code", "provider_error_param",
    "response_status", "response_status_type", "response_status_reason",
    "tool_name", "tool_call_id_hash", "tool_status",
    "retry", "audio_bytes", "tts_audio_chunks", "followup_requested",
)
